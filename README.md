...
> Задачи
 ...
 • идентификатор исполнителя, внешний ключ, integer).
...
> Контракты
 • идентификатор, первичный ключ, serial,
 • номер контракта, varchar(50),
 • дата контракта, date,
 • сумма контракта, numeric,
 • идентификатор клиента, внешний ключ, integer,
 • идентификатор проекта, внешний ключ, integer).

> Отчёты
 • идентификатор, первичный ключ, serial,
 • название отчёта, varchar(100),
 • описание, text,
 • путь к файлу, varchar(255),
 • дата создания, date,
 • идентификатор создателя (сотрудника), внешний ключ, integer).
